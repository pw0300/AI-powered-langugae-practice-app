  ...
  return (
    <main className="container mx-auto flex flex-col items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md mx-auto p-4 text-center animate-fade-in">
            ...
            <p className="text-base sm:text-lg text-slate-400 mb-8">Please select your practice language.</p>
            ...
            <div className="space-y-3">
                ...
                >
                    <span className="text-base sm:text-lg font-semibold">{lang.name}</span>
                </button>
                ))}
            </div>
        </div>
