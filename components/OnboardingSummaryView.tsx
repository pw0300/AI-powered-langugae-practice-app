...
export const OnboardingSummaryView: React.FC<OnboardingSummaryViewProps> = ({ goals, level, onConfirm, onBack }) => {
  return (
    <div className="w-full max-w-2xl mx-auto p-4 text-center animate-fade-in">
      <h1 className="text-3xl font-bold text-white mb-2">Great! Let's get started.</h1>
      <p className="text-lg text-slate-400 mb-6">We'll recommend scenarios based on your goals and level:</p>
      
      <div className="mb-8 p-6 bg-slate-800/50 rounded-lg max-w-md mx-auto">
