...
export const LearningPathView: React.FC<LearningPathViewProps> = ({ path, completedScenarios, onSelectScenario }) => {
      ...
      <div className="relative pl-5">
        ...
        <div className="space-y-8">
          {path.map((scenario, index) => {
            ...
            return (
              <div key={scenario.id} className="flex items-center gap-6">
                ...
                <button
                  ...
                  disabled={isLocked}
                  className={`w-full text-left p-4 rounded-lg border transition-all duration-200 ${buttonClasses}`}
                >
