...
export const ProfileView: React.FC<ProfileViewProps> = ({ onSelectScenario }) => {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto animate-fade-in">
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Your Progress</h1>
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">Unlocked Achievements</h2>
